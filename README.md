# Сайт строительной компании «Русградстрой»
...
Корпоративный сайт для современной строительной компании. Сайт представляет компанию в интернете, демонстрирует портфолио работ, предоставляет информацию об услугах и упрощает процесс связи с потенциальными клиентами.

## 🛠️ Технологии и стек

*   **Фронтенд:**
    *   HTML5, CSS3 (с использованием Flexbox/Grid)
    *   JavaScript (ES6+)

*   **Прочее:**
    *   Система контроля версий: Git
    *   Оптимизация изображений, адаптивная верстка (Responsive Design)
